...
namespace VeduBoxUnitTest.Kurumsal.Pages{
    class BranchPage : Page{
        ...
        private static By ADD_BUTTON = By.CssSelector("button[ng-click='branch={ id: 0 }']");
        private static By NAME = By.CssSelector("input[ng-model='branch.name']");
        private static By LIMIT = By.CssSelector("input[ng-model='branch.userLimitCount']");
        private static By SAVE_BUTTON = By.CssSelector("button[class='btn btn-default btn-oval mb5'][type='submit']");
        private static By SUCCESS = By.CssSelector("[class='toast ng-scope toast-success']");
        private static By DELETE_BUTTON = By.CssSelector("button[ng-click='delete()']");
